...
const CurrencyConverter = () => {
  ...
  const handleFavorite = (currentFav) => {
    let updatedFavorites = [...favorites]
    if (favorites.includes(currentFav)) {
        updatedFavorites = updatedFavorites.filter((fav) => fav !== currentFav)
    } else {
        updatedFavorites.push(currentFav)
    }
